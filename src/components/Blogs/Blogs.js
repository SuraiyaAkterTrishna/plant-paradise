...
const Blogs = () => {
    return (
        <div className = "container my-5">
            <div className='bg-primary rounded p-4 text-white my-5'>
            ...
            <div className='bg-success rounded p-4 text-white my-5'>
            ...
            <div className='bg-danger rounded p-4 text-white my-5'>
